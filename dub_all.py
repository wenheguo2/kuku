...
# "done" status is NO LONGER persisted: it's re-derived every run from the
# existence of each output mp3 (see scan loop, out_file.exists() check), so the
# old 200MB+ progress file was pure redundant bloat.
done_ids = set()
failed_log = []
