...
3-12 岁儿童故事/儿歌/启蒙产品（NestJS 后端 + Taro 微信小程序 + Expo Android/iOS App + Vue3 管理后台 + AI 内容生产管线）。
...
| [`开发文档/00-代码地图.md`](开发文档/00-代码地图.md) | 服务端、小程序、App、管理端结构与关键契约 |
...
app/      Expo 57 + React Native 0.86            npm start / npm run type-check
